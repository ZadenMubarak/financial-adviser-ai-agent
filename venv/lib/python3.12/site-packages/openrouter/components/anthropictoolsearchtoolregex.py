...
AnthropicToolSearchToolRegexName = Literal["tool_search_tool_regex",]


AnthropicToolSearchToolRegexType = Union[
    Literal[
...
class AnthropicToolSearchToolRegexTypedDict(TypedDict):
...
class AnthropicToolSearchToolRegex(BaseModel):
    name: AnthropicToolSearchToolRegexName
