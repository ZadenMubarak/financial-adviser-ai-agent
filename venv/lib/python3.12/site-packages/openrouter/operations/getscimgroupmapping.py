...
class GetScimGroupMappingGlobalsTypedDict(TypedDict):
...
class GetScimGroupMappingGlobals(BaseModel):
...
class GetScimGroupMappingRequestTypedDict(TypedDict):
    id: str
    http_referer: NotRequired[str]
    r"""The app identifier should be your app's URL and is used as the primary identifier for rankings.
    This is used to track API usage per application.
...
class GetScimGroupMappingRequest(BaseModel):
    id: Annotated[
